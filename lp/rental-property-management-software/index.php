...
Header( "Location: http://go.resmancloud.com/rental-property-management-software" );
?>

<?php
include '../php/config.php';
$site = new site();
$site->head("Rental Property Management Software");
$site->nav() ?>
...
<section class="request-demo white">
    <div class="container">
        <div class="col-sm-7 content">
            ...
            <h2 class="text-center">The #1 Rental Property Management Software.</h2>
            <img class="img-responsive" src="<?php echo $site->baseUrl('img/mac-with-resman.png')?>" style="margin: 20px auto" />
            <p class="lead">ResMan is the <strong>only</strong> rental property management software that works the way you do.  With the easy-to-use interface you can review a delinquent account, follow up on a work order, or manage your portfolio—all within 3 clicks or less. </p>
            <p class="lead">ResMan's rental property management software also features:</p>
            <ul>
        ...
        <div class="col-sm-5">
            <div class="well">
                <div class="well-content">
                    <h3 class="text-center light" style="margin-top: 0">Get Your Free Demo Today.</h3>
