...
class site {
    ...
    function baseUrl($page = "") {
        ...
        //$base_url = "http://45.55.4.80/dev/resman/";
    ...
    function head($title=false, $description=false, $author=false) {
        ...
        <head>
            ...
            <link href='http://fonts.googleapis.com/css?family=Roboto:400,300,100,700,900' rel='stylesheet' type='text/css'>
    ...
    function footerLinks() { ?>
        ...
        <script src="<?php echo self::baseUrl("lib/bootstrap/js/bootstrap.js")?>"></script>
        <script src="<?php echo self::baseUrl("js/main.js")?>"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/masonry/3.3.0/masonry.pkgd.min.js"></script>
        <script src="<?php echo self::baseUrl("lib/mason/dist/mason.min.js")?>"></script>
        <script src="<?php echo self::baseUrl("lib/debounce/jquery.ba-throttle-debounce.js")?>"></script>
        <script src="<?php echo self::baseUrl("lib/isotope/isotope.min.js")?>"></script>
        </body>
        </html>
    <?php }
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right visible-xs">
                        <li class="dropdown btn-primary">
                            <a href="<?php echo self::baseUrl('product-tour') ?>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Tour <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="<?php echo self::baseUrl('products/product-tour') ?>">Take A Tour</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo self::baseUrl('service') ?>">Service</a></li>
                        ...
                        <li class="btn-primary"><a href="<?php echo self::baseUrl('integrations') ?>">Integrations</a></li>
                        <li class="btn-primary"><a href="http://blog.resmancloud.com">Blog</a></li>
                        <li class="btn-primary"><a href="<?php echo self::baseUrl('about-us') ?>">About</a></li>
                    ...
                    <div class="navbar-right hidden-xs">
                        <a href="http://go.resmancloud.com/request-demo"><button type="button" class="btn navbar-btn">Try It Out</button></a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="<?php echo self::baseUrl('integrations/') ?>" class="btn btn-sm">
                                    Partners
                                </a>
                            </li>
                            <li>
     ...
     */
    function cta() { ?>
        <section class="tour-cta navy">
            <div class="container">
                <h1 class="text-center white">
                    Make The Switch To ResMan Today.
                </h1>
                <div class="lead text-center text-white">
                    Side effect <s>may</s> <b>will</b> include less stress, lower expenses, and happier employees.
                </div>
                <div class="row">
                    <div class="col-sm-6">
                ...
                <div class="btn-cta btn-cool btn-green right">
    ...
    function integrationPartners() {
        return array(
            ...
            array (
                'name'=>'ILoveLeasing',
                'url'=>'iloveleasing',
                'img'=>'iloveleasing_hz.png',
                'category'=>'CRM'
            ),
            array (
                'name'=>'ApartmentWebsites',
                'url'=>'apartmentwebsites',
                'img'=>'apartment_websites.png',
    ...
    function partnerNav() {
        ...
        <a href="<?php echo self::baseUrl('integrations/') ?>" class="btn btn-default pull-left" style="margin-left: 14px;">
            <i class="glyphicon glyphicon-circle-arrow-left"></i>
            &nbsp;Back
        </a>
